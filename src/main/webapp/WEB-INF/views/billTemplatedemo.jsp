                    ...
                    <div class="py-2">
                        ...
                        <div class="table-responsive">
                            <table class="table align-middle table-nowrap table-centered mb-0">
                                ...
                                <tbody>
                                <c:forEach items="${pur}" var="p">
                                    <tr>
                                        <th scope="row">${p.product.id}</th>
                                        <td>
                                            <div>
                                                <h5 class="font-size-3 mb-1">${p.product.prodName}</h5>
                                                <p class="text-muted mb-0">${p.product.prodDesc}</p>
                                            </div>
                                        </td>
                                         <td>$ ${p.product.prodCostPrice}</td>
                                        <td>${p.totalUnit}</td>
                                        <td class="text-end">$ ${p.totalCostPrice}</td>
                                    </tr>
                                    <!-- <tr>
                                        <th scope="row">02</th>
                                        <td>
